              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between mt-4">
                  <div class="user-group able-user-group">
                    <img src="{{ asset('images/user/avatar-1.jpg')}}" alt="user-image" class="avtar" />
                    <img src="{{ asset('images/user/avatar-3.jpg')}}" alt="user-image" class="avtar" />
                    <img src="{{ asset('images/user/avatar-4.jpg')}}" alt="user-image" class="avtar" />
                    <img src="{{ asset('images/user/avatar-5.jpg')}}" alt="user-image" class="avtar" />
