    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <div class="card pc-user-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-2 me-1">
            ...
            <li class="pc-item"><a class="pc-link" href="../dashboard/finance.html">Finance</a></li>
                ...
                <li class="pc-item">
                    <a href="{{ route('register.store') }}" class="pc-link">
                        <span class="pc-micon">
                            <svg class="pc-icon">
                                <use xlink:href="#custom-user"></use>
                            </svg>
                        </span>
                        <span class="pc-mtext">Create User</span>
                    </a>
                </li>
                <li class="pc-item">
                    <a href="{{ route('ndr.list') }}" class="pc-link">
                        <span class="pc-micon">
                            <svg class="pc-icon">
        ...
        <li class="pc-item">
          <a href="../elements/animation.html" class="pc-link">
            ...
            ><span class="pc-mtext">Animation</span></a
          >
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link"
