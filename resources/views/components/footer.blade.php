                ...
                <li class="list-group-item">
                    ...
                    <div class="theme-main-layout d-flex align-center gap-1 w-100">
                        <a href="#!" data-bs-toggle="tooltip" title="Vertical" class="active"
                            data-value="vertical">
                            <img src="{{ asset('images/customizer/caption-on.svg') }}" alt="img"
                                class="img-fluid" />
                        </a>
                        <a href="#!" data-bs-toggle="tooltip" title="Horizontal" data-value="horizontal">
                            <img src="{{ asset('images/customizer/horizontal.svg') }}" alt="img"
                                class="img-fluid" />
                        </a>
                        <a href="#!" data-bs-toggle="tooltip" title="Color Header" data-value="color-header">
                            <img src="{{ asset('images/customizer/color-header.svg') }}" alt="img"
                                class="img-fluid" />
                        </a>
                        <a href="#!" data-bs-toggle="tooltip" title="Compact" data-value="compact">
                            <img src="{{ asset('images/customizer/compact.svg') }}" alt="img"
                                class="img-fluid" />
                        </a>
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn-img btn" data-value="false"
                                    ...
                                    title="Caption Hide">
                                    <img src="{{ asset('images/customizer/caption-off.svg') }}" alt="img"
                                        class="img-fluid" />
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        title="LTR">
                                        <img src="{{ asset('images/customizer/ltr.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        <img src="{{ asset('images/customizer/rtl.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        title="Full Width">
                                        <img src="{{ asset('images/customizer/full.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        title="Fixed Width">
                                        <img src="{{ asset('images/customizer/fixed.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
