     ...
     <div class="offcanvas-body">
         ...
         <div class="card mb-3">
             <div class="card-body">
                 ...
                 <img src="{{ asset('images/layout/img-announcement-1.png') }}" alt="img"
         ...
         <div class="card mb-3">
             <div class="card-body">
                 ...
                 <p class="text-muted">Do you know Able Pro is one of the featured dashboard template selected by
                     Themeforest team.?</p>
                 <img src="{{ asset('images/layout/img-announcement-3.png') }}" alt="img" class="img-fluid" />
             </div>
         </div>
         <div class="card mb-3">
             <div class="card-body">
                 ...
                 <img src="{{ asset('images/layout/img-announcement-4.png') }}" alt="img" class="img-fluid" />
             </div>
         </div>
     </div>
 </div>
